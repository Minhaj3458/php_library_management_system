...
?>
        ...
        <!-- ========================================================= -->
            ...
            <div class="row animated fadeInRight">
                <div class="col-sm-12">
                    <h4 class="section-subtitle"><b>All Students <?php  $stu_id = $_SESSION['student_id'] ;
                    echo($stu_id);
                    ?></b></h4>
                    <div class="panel">
                            ...
                            <div class="table-responsive">
                                <table id="basic-table" class="data-table table table-striped nowrap table-hover" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                          ...
                                          $text_query = "SELECT `issue_book`.`book_issue_date`,`books`.`book_name`, `books`.`book_image`FROM `books` INNER JOIN `issue_book` ON `issue_book`.`book_id` = `books`.`id` 
                                           WHERE `issue_book`.`student_id` = $stu_id ";
                                         $text_check = mysqli_query($con,$text_query);
                                         while ($row = mysqli_fetch_assoc($text_check)){
                                          ?>
                                           <tr>
                                               <td><?= $row['book_name']?></td>
                                               <td><img style="width:150px; height:150px;" src="../Upload_Images/Books_image/<?= $row['book_image']?>" alt=""></td>
