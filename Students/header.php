...
$page_in = end($page);
 ...
 $stu_email = $_SESSION['student_login'];
 $text_query = "SELECT * FROM `students_reg` WHERE `email` = '$stu_email' OR `username` = '$stu_email' ";
            ...
            <div class="rightside-header">
                            ...
                            <div class="drop-content">
                                <div class="widget-list list-left-element list-sm">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="">
                                                <div class="left-element"><i class="fa fa-students color-dark"></i></div>
                                                <div class="text">
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        ...
                        <div class="user-info">
                            <span class="user-name"><?= ucwords($row['username']) ?></span>
                        ...
                        <nav>
                            <ul class="nav nav-left-lines" id="main-nav">
                                ...
                                <li class="<?= $page_in == 'index.php' ? 'active-item': ''?>"><a href="index.php"><i class="fa fa-home" aria-hidden="true"></i><span>Dashboard</span></a></li>
                                 <li class="<?= $page_in == 'Book.php' ? 'active-item': ''?>"><a href="Book.php"><i class="fa fa-home" aria-hidden="true"></i><span>Book</span></a></li>
                                <!--UI ELEMENTENTS-->
                                <li class="has-child-item ">
                                    <a href="display_issue_book.php"><i class="fa fa-book" aria-hidden="true">Display Issue Book</i><span></span></a>
                                </li>
